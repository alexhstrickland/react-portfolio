    ...
    return(
        <main className="container">
            ...
            <section className="row">
                ...
                <p className="links">
                    <a href="mailto:alexhstrickland@gmail.com" className="far fa-envelope"></a>
                    <a href="https://www.linkedin.com/in/alexandrastrickland/" className="fab fa-linkedin-in"></a>
                    <a href="https://github.com/alexhstrickland" className="fab fa-github"></a>
                </p>
                </section>
            </section>
            </section>
